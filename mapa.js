...
var azul = L.icon
	...
	var THEHOUSEBAR= L.marker([-34.79793, -58.38768], {icon: azul},13).bindPopup("<strong>The House Bar<strong>" + "<br/>" + "Direccion: Cerreti 831" + "<br/>" +"IINSTAGRAM: @ THEHOUSEBARFOOD").on('click', xxy);
	var GIBSONBAR= L.marker([-34.79681, -58.39143], {icon: azul},13).bindPopup("<strong>Gibson Bar<strong>" + "<br/>" + "Direccion: Macias 589 " +"<br/>" + "INSTAGRAM: @ GIBSONBAR_ADROGUE").on('click', xxy);
	...
	var MOEBIUSBAR= L.marker([-34.79681, -58.39143], {icon: azul},13).bindPopup("<strong>Moebius Bar<strong>" + "<br/>" + "Direccion: Castelli 1003" +"<br/>" + "INSTAGRAM: @ MOEBIUSBAR").on('click', xxy);
	var MOCCA= L.marker([-34.79818, -58.38531], {icon: azul},13).bindPopup("<strong>Mocca<strong>" + "<br/>" + "Direccion: Plaza Alte. Brown 303" +"<br/>" + "INSTAGRAM: @ MOCCACOFFEEBAR").on('click', xxy);
	var THEMITRE= L.marker([-34.79731, -58.39181], {icon: azul},13).bindPopup("<strong>The Mitre<strong>" + "<br/>" + "Direccion: Mitre 1171" + "<br/>" +"INSTAGRAM: @ _THEMITRE").on('click', xxy);
	...
	var LACOLORADA= L.marker([-34.79706, -58.39106], {icon: azul},13).bindPopup("<strong>La Colorada<strong>" + "<br/>" + "Direccion: Mitre 1230 " + "<br/>" +"INSTAGRAM: @ LACOLORADACLUB").on('click', xxy);
	var DEBARY  = L.marker([-34.80118, -58.38843], {icon: azul},13).bindPopup("<strong>Debary<strong>" + "<br/>" + "Direccion: Av. Espora 919").on('click', xxy);
	var EL_BUFET  = L.marker([-34.79868, -58.39143], {icon: azul},13).bindPopup("<strong>El Buffet<strong>" + "<br/>" + "Direccion: Spiro 1093 " +"<br/>" + "INSTAGRAM: @ ELBUFETBAR").on('click', xxy);
	var ROX_CLUB = L.marker([-34.79906, -58.39218], {icon: azul},13).bindPopup("<strong>Roxi Club<strong>" + "<br/>" + "Direccion: Spiro 1051" + "<br/>" +"INSTAGRAM: @ROXCLUB.BA").on('click', xxy);
	...
	var LA_ESTACION_BUENA_BIRRA  = L.marker([-34.79706, -58.38931], {icon: azul},13).bindPopup("<strong>La Estacion de la Buena Virra<strong>" + "<br/>" + "Direccion: BARTOLOMÉ MITRE 1230 " +"<br/>" + "INSTAGRAM: @ LAESTACIONDELABUENABIRRA").on('click', xxy);
	var EL_RINCON  = L.marker([-34.79593, -58.38931], {icon: azul},13).bindPopup("<strong>El Rincón<strong>" + "<br/>" + "Direccion: Mitre y Ferrari" + "<br/>" +"INSTAGRAM: @ RINCONCERVECERIA").on('click', xxy);
	var LOCOS_BIRRA  = L.marker([-34.79731, -58.39031], {icon: azul},13).bindPopup("<strong>Locos por la Birra<strong>" + "<br/>" + "Direccion: Diagonal Brown 1272 " +"<br/>" + "INSTAGRAM: @ LOCOSPORLABIRRA.ADROGUE").on('click', xxy);
	var DEWEY_BREWING_CO = L.marker([-34.79756, -58.38606], {icon: azul},13).bindPopup("<strong>Dewey Brewing CO<strong>" + "<br/>" + "Direccion: Diagonal Brown 1571 " +"<br/>" + "INSTAGRAM: @ CERVEZADEWEY").on('click', xxy);
	var BAUM = L.marker([-34.79743, -58.39143], {icon: azul},13).bindPopup("<strong>Baum Adrogué<strong>" + "<br/>" + "Direccion: Mitre 1184 " + "<br/>" +"INSTAGRAM: @ BAUMADROGUE").on('click', xxy);
	...
	var VANDONI  = L.marker([-34.80606, -58.38568], {icon: azul},13).bindPopup("<strong>Vandoni<strong>" + "<br/>" + "Direccion: Murature 1135").on('click', xxy);
	...
	var SOUTH_SIDE_OF_BEER  = L.marker([-34.79893, -58.39268], {icon: azul},13).bindPopup("<strong>South Side of Beer<strong>" + "<br/>" + "Direccion: Somellera 657 " + "<br/>" +"INSTAGRAM: @ SOUTHSIDEOFBEER").on('click', xxy);
	var DE_LA_BARRA = L.marker([-34.82593, -58.39718], {icon: azul},13).bindPopup("<strong>De la Barra<strong>" + "<br/>" + "Direccion: Av Hipolito Irigoyen 14770 " + "<br/>" +"INSTAGRAM: @ DELABARRACERVECERIA").on('click', xxy);
	var CERVECERIA_ALMIRANTE_BROWN  = L.marker([-34.82468, -58.39718], {icon: azul},13).bindPopup("<strong>Cerveceria Almirante Brown<strong>" + "<br/>" + "Direccion: HIPÓLITO YRIGOYEN 14687" + "<br/>" +"INSTAGRAM: @ ALTEBROWNCERVECERIA").on('click', xxy);
	var LA_ESQUINA_DE_LA_CERVEZA  = L.marker([-34.82856, -58.39418], {icon: azul},13).bindPopup("<strong>La Esquina de la Cerveza<strong>" + "<br/>" + "Direccion: AAlsina 595" + "<br/>" +"INSTAGRAM: @ LAESQUINADELACERVEZA").on('click', xxy);
	...
	var ALMIRANTE_CERVEZA   = L.marker([-34.78781, -58.37393], {icon: azul},13).bindPopup("<strong>Almirante Dönn Cerveza<strong>" + "<br/>" + "Direccion: Mitre 2680" + "<br/>" +"INSTAGRAM: @ ALMIRANTEDONN").on('click', xxy);
	var EL_CLASICO_DE_QUILMES   = L.marker([-34.80831, -58.40106], {icon: azul},13).bindPopup("<strong>El Clasico de Quilmes<strong>" + "<br/>" + "Direccion: AV HIPÓLITO YRIGOYEN 13298").on('click', xxy);
	...
	var KINGSTON_BEER  = L.marker([-34.79981, -58.33718], {icon: azul},13).bindPopup("<strong>Kingstone Beer<strong>" + "<br/>" + "Direccion: LOBATO 751" + "<br/>" +"INSTAGRAM: @ KINGSTONBEER").on('click', xxy);
	...
	var BROOKLYN = L.marker([-34.86093, -58.38968], {icon: azul},13).bindPopup("<strong>Brooklyn Beer & Coffe<strong>" + "<br/>" + "Direccion: AV HIPÓLITO YRIGOYEN 18391 " + "<br/>" +"INSTAGRAM: @ BROOKLYN_BEER_COFFEE").on('click', xxy);
	...
	var BOCEPHUS_PRODUCCIONES  = L.marker([-34.86118, -58.39343], {icon: azul},13).bindPopup("<strong>Bocephus roducciones <strong>" + "<br/>" + "Dirección: JUAN DE GARAY 699 " + "<br/>" + "INSTAGRAM: @ CLAUDIO_PINEIRO_BOCEPHUS").on('click', xxy);
